var MyUWCard=function(a){'use strict';class b extends HTMLElement{static get elementName(){return"myuw-card-content"}static get template(){return void 0===this._template&&(this._template=document.createElement("template"),this._template.innerHTML=`
      ...
      `),this._template}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(d.template.content.cloneNode(!0))}}window.customElements.define(d.elementName,d);class e extends HTMLElement{static get elementName(){return"myuw-card-frame"}static get template(){return void 0===this._template&&(this._template=document.createElement("template"),this._template.innerHTML=`
        ...
        <slot></slot>
      `),this._template}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(e.template.content.cloneNode(!0))}}window.customElements.define(e.elementName,e);class f extends HTMLElement{static get elementName(){return"myuw-card-message"}static get template(){return void 0===this._template&&(this._template=document.createElement("template"),this._template.innerHTML=`
        <style>
          :host {
            font-weight: lighter;
            font-size: 14px;
